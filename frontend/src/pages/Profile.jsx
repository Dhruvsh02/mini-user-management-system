...
import { User, Mail, Save, ArrowLeft, Sparkles, CheckCircle, XCircle } from "lucide-react";
            ...
            <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 w-full max-w-md text-white relative z-10 shadow-2xl">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative group">
                        ...
                        <div className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white/5 backdrop-blur-md border border-white/20 text-white/70">
                            {user.email}
                        </div>
                    </div>
                    <p className="text-white/50 text-xs mt-1 ml-1">Email cannot be changed</p>
                </div>
